...
Route::controller(JobController::class)->group(function () {
    ...
    Route::get("/all/jobs/view", "index_view")->name("jobs_view")->middleware("check_user_type:1");
    ...
    Route::get('/jobs/{id}/show','show')->name('show_job')->middleware("check_user_type:1");
    ...
    Route::get("/jobs/filter","jobs_filter")->name("jobs_filter")->middleware("check_user_type:1");
})->middleware("auth");
